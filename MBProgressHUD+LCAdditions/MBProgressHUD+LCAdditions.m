//
//  MBProgressHUD_LCAdditions.m
//  MBProgressHUD+LCAdditions
//
...
+ (void)showErrorWithStatus:(NSString *)status InView:(UIView *)view{
  [self show:status icon:[UIImage imageNamed:@"MBProgressHUD+LCAdditions.bundle/error@2x.png"] view:view];
}

#pragma mark 显示成功信息
+ (void)showSuccessWithStatus:(NSString *)status InView:(UIView *)view
{
  [self show:status icon:[UIImage imageNamed:@"MBProgressHUD+LCAdditions.bundle/success@2x.png"] view:view];
}
